          ...
          <nav aria-label="Dashboard navigation" className="order-3 flex w-full flex-wrap items-center gap-2 sm:order-2 sm:w-auto">
            {user.role === "TEAM_ADMIN" ? (
              <>
                ...
                <Link className="rounded-full px-4 py-2 text-sm font-semibold text-white/65 transition hover:bg-white/5 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ffb800]" href="/admin/messages">
                  Messages
                </Link>
                <Link className="rounded-full px-4 py-2 text-sm font-semibold text-white/65 transition hover:bg-white/5 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ffb800]" href="/admin/audit">
                  Audit log
                </Link>
