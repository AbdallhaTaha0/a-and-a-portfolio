...
import { getOwnExperience } from "@/server/members/owned-timeline";
...
export default async function ExperiencePage() {
  ...
  const records = await getOwnExperience(member.id);
  ...
  return (
    <div>
      ...
      <p className="mt-3 max-w-2xl leading-7 text-white/55">
        Describe your roles and contributions. Each entry remains owned by your member
        profile and cannot be changed by another member.
      </p>
